...
- [DuckDB in Action](https://www.manning.com/books/duckdb-in-action) - A book that introduces the DuckDB database and shows how to use it to solve common data workflow problems.
